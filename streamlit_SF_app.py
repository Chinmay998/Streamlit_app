...
df_forecast =pd.read_sql ("SELECT top 10  POSTAL_CODE,MAX(MAX_TEMPERATURE_FEELSLIKE_2M_F)MAX_TEMPERATURE_FEELSLIKE_2M_F,DATE_VALID_STD FROM GLOBAL_WEATHER_REPORT.CLIMATE.FORCAST_DAY where DATE_VALID_STD ='2023-04-11'  AND COUNTRY = 'US'  group by POSTAL_CODE,DATE_VALID_STD ",conn)
