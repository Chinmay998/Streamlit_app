...
df_history = pd.read_sql ("SELECT  POSTAL_CODE,MAX(MAX_TEMPERATURE_FEELSLIKE_2M_F)MAX_TEMPERATURE_FEELSLIKE_2M_F,DATE_VALID_STD FROM CLIMATE.HISTORY_DAY where DATE_VALID_STD between '2023-04-02' AND '2023-04-12' COUNTRY = 'US' AND DATE_VALID_STD <= '2023-04-18' group by POSTAL_CODE,DATE_VALID_STD limit 10",conn)
#st.write(df_history)

df_forecast =pd.read_sql ("SELECT  POSTAL_CODE,MAX(MAX_TEMPERATURE_FEELSLIKE_2M_F)MAX_TEMPERATURE_FEELSLIKE_2M_F,DATE_VALID_STD FROM GLOBAL_WEATHER_REPORT.CLIMATE.FORCAST_DAY where DATE_VALID_STD between '2023-04-02' AND '2023-04-12' COUNTRY = 'US' AND DATE_VALID_STD <= '2023-04-18' group by POSTAL_CODE,DATE_VALID_STD limit 10",conn)
